...
The light of power is the location that Thor is trying to get to and in order to do this process you will use if statements to create an argument that will move thor in to the placement of the light of power.
