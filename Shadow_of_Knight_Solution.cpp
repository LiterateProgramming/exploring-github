...
example, as we can see in the pictureabove the bomb is up and to the right. The code can unfortunarly not see this, but the game does give us some help, it gives the bomb's direction. These are in terms of letters specified in detail below.
